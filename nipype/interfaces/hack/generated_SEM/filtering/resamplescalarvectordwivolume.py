...
class ResampleScalarVectorDWIVolumeInputSpec(CommandLineInputSpec):
    ...
    hfieldtype = traits.Enum("displacement", "h-Field", argstr="--hfieldtype %s", desc="Set if the deformation field is an h-Field")
    interpolation = traits.Enum("linear", "nn", "ws", "bs", argstr="--interpolation %s", desc="Sampling algorithm (linear or nn (nearest neighborhoor), ws (WindowedSinc), bs (BSpline) )")
    ...
    rotation_point = traits.List(argstr="--rotation_point %s", desc="Rotation Point in case of rotation around a point (otherwise useless)")
    centered_transform = traits.Bool(argstr="--centered_transform ", desc="Set the center of the transformation to the center of the input image")
    ...
    Inverse_ITK_Transformation = traits.Bool(argstr="--Inverse_ITK_Transformation ", desc="Inverse the transformation before applying it from output image to input image")
    ...
    spline_order = traits.Int(argstr="--spline_order %d", desc="Spline Order")
