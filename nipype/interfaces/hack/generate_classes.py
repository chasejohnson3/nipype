...
def generate_all_classes(
    xml_dir: str, out_dir: str, modules_list=[], launcher=[], redirect_x=False, mipav_hacks=False
):
    ...
    for module in modules_list:
        ...
        package, code, module = generate_class(
            module, launcher, xml_dir, redirect_x=redirect_x, mipav_hacks=mipav_hacks
        )
...
def generate_class(
    module, launcher, xml_dir: str, strip_module_name_prefix=True, redirect_x=False, mipav_hacks=False
):
    dom = grab_xml(module, xml_dir)
...
def grab_xml(module, xml_dir: str):
    try:
